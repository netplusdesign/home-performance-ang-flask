...
describe('YearlyCtrl', function() {
	...
	it('should insert avg. daily usage when view == summary', function() {
		...
		mockData = {"totals":{"used":"12806.756","solar":"-17430.964","net":"-4624.208","hdd":"12695.097"},"years":[{"date":"2012-02-01","used":"5600.602","solar":"-8856.387","net":"-3255.785","hdd":"5884.847"},{"date":"2013-01-01","used":"7206.154","solar":"-8574.577","net":"-1368.423","hdd":"6810.250"}]};
...
describe('MonthlyCtrl', function() {
	...
	it('should show error when view == summary and returned month object == null', function() {
		mockData = {"totals":{"used":null,"solar":null,"net":null,"hdd":null},"months":[]}; 
		var controller = createController();
		scope.$apply();
		expect(scope.warning).toBe(true);
	});
